...
|-------------------|----------------|--------|
| ![Gallery](ui_tests/screenshots/gallery_with_artwork.png) | ![Detail](ui_tests/screenshots/artwork_detail.png) | ![Mobile](ui_tests/screenshots/gallery_mobile.png) |

| Manage | Upload | Filter Active |
|--------|--------|---------------|
| ![Manage](ui_tests/screenshots/manage_list.png) | ![Upload](ui_tests/screenshots/upload_form.png) | ![Filters](ui_tests/screenshots/gallery_filter_tabs.png) |

> Screenshots are generated automatically by the Playwright UI test suite. Run `pytest ui_tests/` with the server running to regenerate them.
...
|-------|------|-------|
| Title | Text | Required |
| Image | Image | Required — opens camera on mobile |
...
Browser-based tests against the live dev site. Screenshots are saved to `ui_tests/screenshots/`.
...
artpage/
  ...
  ui_tests/
    ...
    test_detail.py
    test_upload.py
    screenshots/              # Auto-generated by test runs
```
